package com.bruno.daniel.navarro.nunez.sidesheetdialog.ui.threeXmlActivity
...
class ThreeXMLActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_three_xmlactivity)
